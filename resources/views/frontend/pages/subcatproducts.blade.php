	...
	<main id="main" class="main-site left-sidebar">
			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="wrap-shop-control">
						...
						<h1 class="shop-title">Sous-catégories Liste de produits Wise</h1>
						...
						<div class="widget-content">
							...
							@php
								...
								//dd($subcategories);
									...
									// $id = App\Models\subcategory::where('category_id', $item->id)->value('id');

									@endphp 


							<ul class="list-category">
								<li class="category-item has-child-cate <?php if($item->id==$segment1){ ?> open <?php } ?>">
		...
		$class = '';
									...
									<ul class="sub-cate">
										...
										<li class="category-item"><a href="{{route('product-subcat',[$subcat->category_id,$subcat->id])}}" class="cate-link <?php if($subcat->id==$segment2){ ?> subactive <?php } ?> ">{{$subcat->subcategories_name_fr}}</a></li>	
										<!-- <li class="category-item"><a href="{{route('product-cat',$subcat->id)}}" class="cate-link">{{$subcat->subcategories_name_fr}}</a></li>-->
		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>Prodoucts</span></li>
				</ul>
			</div>
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="wrap-shop-control">
						...
						<h1 class="shop-title">SubCategories Wise Product List</h1>
							...
							<ul class="list-category">
								<li class="category-item has-child-cate <?php if($item->id==$segment1){ ?> open <?php } ?>">
									...
									<ul class="sub-cate">
										...
										<li class="category-item"><a href="{{route('product-subcat',[$subcat->category_id,$subcat->id])}}" class="cate-link <?php if($subcat->id==$segment2){ ?> subactive <?php } ?> ">{{$subcat->subcategories_name_en}}</a></li>
