  ...
  <body>
    ...
    <header class="clearfix">
      ...
      <div id="logo">
        ...
        <img src="https://mygalrewards.com/galrewards/frontend/assets/images/logo.jpg">
	  ...
	  <h3>Account Summary</h3>
        ...
        <thead>
          ...
          <tr>
            ...
            <th class="unit">Points Earned</th>

          <th class="unit">Points Used for Products Ordered</th>

            <th class="unit">Point added back for returned items</th>
...
@foreach ($getalldetail as $item)
    ...
    <tr>
      ...
      <td class="qty">{{ ($item->points + $item->bonus_points)  ?? '-' }}</</td>
      <td class="qty">{{ $item->order_points ?? '-' }}</</td>
      <td class="qty">{{ $item->return_points ?? '-' }}</td>

     <td class="total">{{ $item->closing_balance ?? '' }}</td>
